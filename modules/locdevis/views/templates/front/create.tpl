...
<div class="content">
    <div class="row">
        <section id="center_column" class="span9">
            ...
            {/if}
            {if $showForm}
            <form action="{$link->getModuleLink('locdevis', 'createquotation')|escape:'htmlall':'UTF-8'}" method="post" class="contact-form-box" enctype="multipart/form-data" id="locDevisForm">
                ...
                <div class="container">
                    ...
                    <table class="table table-bordered stock-management-on" id="cart_summary">
                        ...
                        *}
                        ...
                        <tr class="cart_total_price">
                         ...
                         <td class="price" id="locQuotationTotalQuotation">{convertPrice price=$summary.total_price_without_tax}</td>
                        </tr>
                        <tr class="cart_total_price">
                         <td colspan="4" class="text-right">{l s='Total shipping' mod='locdevis'} {if $priceDisplay==1}{l s='tax excl.' mod='locdevis'}{/if}</td>
                         <td class="price" id="locQuotationTotalShipping">{if $priceDisplay==1}{convertPrice price=$summary.total_shipping_tax_exc}{else}{convertPrice price=$summary.total_shipping}{/if}</td>
                        </tr>
                        <tr class="cart_total_price">
                         <td colspan="4" class="text-right">{l s='Total tax' mod='locdevis'}</td>
                         <td class="price" id="locQuotationTotalTax">{convertPrice price=$summary.total_tax}</td>
                        </tr>
                        <tr class="cart_total_price">
                         <td colspan="4" class="total_price_container text-right">{l s='Total' mod='locdevis'} {l s='tax incl.' mod='locdevis'}</td>
                         <td class="price" id="total_price_container"><span id="locQuotationTotalQuotationWithTax">{convertPrice price=$summary.total_price}</span></td>
                        </tr>
                        </tfoot>
                    </table>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="form-group locDevisConteneurTextarea">
                            ...
                            <textarea class="form-control locDevisTextArea" id="messageVisible" name="message_visible">{if isset($message_visible)}{$message_visible|escape:'htmlall':'UTF-8':'UTF-8'|stripslashes}{/if}</textarea>
                        </div>
                        <div class="form-group locDevisConteneurTextarea">
                            <label for="message_not_visible">{l s='Leave us a message (not visible on quotation)' mod='locdevis'}</label>
                            <textarea class="form-control locDevisTextArea" id="messageNotVisible" name="message_not_visible">{if isset($message_not_visible)}{$message_not_visible|escape:'htmlall':'UTF-8':'UTF-8'|stripslashes}{/if}</textarea>
                        </div>
                    </div>
                    <div class="clearfix">
...
<script type="text/javascript">
    var loc_module_dir = "{$content_dir|escape:'htmlall':'UTF-8'}{$loc_module_dir|escape:'htmlall':'UTF-8'}";
    locDevisControllerUrl = "{$content_dir|escape:'htmlall':'UTF-8'}/index.php?fc=module&module=locdevis&controller=createquotation";
